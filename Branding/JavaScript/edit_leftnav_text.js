...
<class_name> replace with the class name of the link, which for Canvas links is just the displayed text, but in lowercase.
				Links from LTI tools can be updated as well, but their class names will vary, so you'll have to look directly 
				at the HTML. It should look like this though: context_external_tool_<somenumber>
